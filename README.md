...
├── Netflix_Stock_Price_Forecasting.ipynb  # Main notebook with full analysis
├── README.md                              # Project documentation
├── forecast_plot.png                      # (Optional) Forecast plot image
└── requirements.txt                       # List of required packages
🧾 Key Features
📥 Fetches Netflix stock data using yfinance

📊 Visualizes historical price trends

📈 Decomposes time series into trend, seasonality, and noise

🔮 Trains ARIMA model for future price forecasting
